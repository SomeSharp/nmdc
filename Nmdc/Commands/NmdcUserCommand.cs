...
namespace SomeSharp.Nmdc
{
    ...
    public sealed class NmdcUserCommand : NmdcCommand
    {
        ...
        public static NmdcUserCommand Parse(string message)
        {
            ...
            return new NmdcUserCommand(commandType, context, title, lines, commandsGenerator);
        }
